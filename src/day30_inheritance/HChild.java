...
public class HChild extends GParent{
    ...
    HChild(){//görünür parametresiz constructor
    ...
    public static void main(String[] args) {
        ...
        HChild objChild= new HChild();//Grand parent constructor calisti
                                     //Parent constructor calisti
                                    //Child class constructor'i calisti  --  satır 39
        ...
        /*
            ...
            parent ve grandParent class'larindaki tum ozelliklere sahip olur (private ve static hariç)
