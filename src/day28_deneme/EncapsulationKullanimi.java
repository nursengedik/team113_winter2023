...
/*
    ...
    oncelikle access modifier ile kimsenin ulasamamasini saglayin (access modifier ini private yaparız ve ulaşılamaz)

    private yaparak kimsenin ulasamayacagini garantiye aldiktan sonra
    READ yetkisi vermek istediklerimiz icin getter() (yazdırma)
    WRITE yetkisi vermek istediklerimiz icin setter() (değer atama var)olusturmaliyiz
 */
