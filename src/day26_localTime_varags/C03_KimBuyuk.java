...
public class C03_KimBuyuk {
    public static void main(String[] args) {
        ...
        LocalDate tarih1 = LocalDate.of(yil,ay,gun);//girilen değerlerle Local Date oluşturulur
        ...
        LocalDate tarih2 = LocalDate.of(yil,ay,gun);//girilen değerlerle Local Date oluşturulur

        System.out.println(tarih2.isAfter(tarih1) ?//tarih 2 tarih 1 den sonraysa
                "Buyuk olan "+isim1 :
                "Buyuk olan "+isim2);
    }
}