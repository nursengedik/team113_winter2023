...
public class C08_Varargs {
    ...
    public static void main(String[] args) {
        ...
        topla(3,4); // [3, 4]  7         yazdıklarımızı bir array olarak yazdırır
    ...
    public static void topla(int... a){
        ...
        System.out.println(Arrays.toString(a));//array ı yazdırmak
    ...
    /*
        ...
        varargs bir ARRAY'dir  (varargs array in alt yapısını kullanır)
