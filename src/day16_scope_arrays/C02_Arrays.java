...
public class C02_Arrays {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(arr)); // [null, null, null, null, null] //çünkü arr'ye değer atamadık
                                                 //string olduğu için null yazdırır

        int[] a = new int[7];
        System.out.println(Arrays.toString(a)); // [0, 0, 0, 0, 0, 0, 0] //değer atanmadı, int olduğu için 0 yazar

        // array'deki elementlere nasil ulasiriz ? index ile

        a[0] = 4; // [4, 0, 0, 0, 0, 0, 0]//arrays'e element ekleme
        a[3] = 7; // [4, 0, 0, 7, 0, 0, 0]
