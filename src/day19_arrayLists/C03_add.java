...
public class C03_add {
    public static void main(String[] args) {
        ...
        sayilar.add(1,7);//1 index'e 7 yi ekle
        ...
        sayilar.addAll(ekler);//addAll de add gibi ekleme yapar,yalnız addAll daha önce oluşturulan array list'i
                             //eklemek istediğimiz başka bir List'in sonuna ekler
