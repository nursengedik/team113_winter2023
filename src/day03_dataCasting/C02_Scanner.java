...
public class C02_Scanner {
    public static void main(String[] args) {
        ...
        System.out.println("Lutfen isminizi, soyisminizi ve yasinizi giriniz" +
                           "\nHer bilgiden sonra ENTER'a basiniz");// bu satırı yazmasak da aşağı satıra iner
                                                                  //çünkü println alt alta yazdırır

        char isimIlkHarf= scan.nextLine().charAt(0);// nextLine() girilen bilginin tamamını alır
                                                    // charAt(0) ilk kelimenin ilk harfini alır
