...
public class C05_LocalVariable {
    ...
    public static void main(String[] args) {
        ...
        String isim = "Ali Can";
        int sayi;
        // System.out.println(sayi); değer atanmadığı için kullanılamaz

        // sayi++;

        for (int i = 0; i < 10; i++) {//for loop içerisindeki değereleri de dışında yazdıramam
                                      //local variable'ın local'i
            int j = i+1;
