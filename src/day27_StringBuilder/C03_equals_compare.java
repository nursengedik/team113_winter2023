...
public class C03_equals_compare {
    public static void main(String[] args) {
        ...
        System.out.println(sb1 == sb2); // false-ikisi de new le oluşturulmuş yani farklı objelerdir
                                       // referans durumundan dolayı false dir, day23-C04 te geçiyor
        ...
        // System.out.println(sb1.compareTo(str)); CTE- çalışmaz

        StringBuilder sb3 = new StringBuilder("Hava");
        StringBuilder sb4 = new StringBuilder("Hara");

        System.out.println(sb1.compareTo(sb3)); // 2//burada bulduğu farklılığın arasındaki farkı verir
