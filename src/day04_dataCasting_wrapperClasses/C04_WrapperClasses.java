...
public class C04_WrapperClasses {
    public static void main(String[] args) {
       ...
       /*
        ...
        int sonuc = Integer.parseInt(sonucStr);//Integer.parseInt: bir string değerini int e çeviriyor
        System.out.println(sonuc+10); // 355

        sonuc= Integer.valueOf(sonucStr);//Integer.valueOf:bir string değerini int e çeviriyor
        System.out.println(sonuc+10); // 355


        char krk='3';

        System.out.println(Character.isDigit(krk)); // true    //isDigit : sayı mı
        System.out.println(Character.isLetter(krk));// false  //isLetter : harf mi
