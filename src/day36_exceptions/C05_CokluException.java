    ...
    public static void main(String[] args) {
        ...
        try {
            int index = scan.nextInt(); // InputMismatchException
                                                    //mesela index 44 girdiğimizde String de girilen inde sınır
                                                   // dışında olduğu için aşağıdaki hatayı verir
            System.out.println(str.charAt(index)); // StringIndexOutOfBoundsException
                                            //girilen index array in sınırları dışında olduğu için hata verir
            System.out.println(arr[index]); //10 girdiğimizde- ArrayIndexOutOfBoundsException
