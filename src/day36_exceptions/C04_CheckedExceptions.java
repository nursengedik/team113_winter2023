...
import java.io.FileNotFoundException;
    ...
    public class C04_CheckedExceptions {
        ...
        public static void main(String[] args) throws FileNotFoundException {//throws keyword sadece kırmızı çizimi
                                                                             //kaldırır
        ...
        /*
            ...
            2- Eger exception'i handle etmek istemiyorsak
               ...
               method signature'ina throws keyword'u ile (sadece kırmızı çizimi kaldırır)
