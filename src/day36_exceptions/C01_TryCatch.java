...
public class C01_TryCatch {
    ...
    public static void main(String[] args) {
        ...
        try {//bu işlemi yapmaya çalış

            System.out.println(sayi1/sayi2);

        } catch (ArithmeticException e) {

            // e.printStackTrace();//exit code 0 olur ekranda
                                  // exception'da gordugumuz tum hata aciklamalarini yazdirir
                                 //karşılaştığın sorunları yazdır ama koda devam et
