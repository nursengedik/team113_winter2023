...
public class C03_ArrayElementleriniBenzersizYapma {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(benzersizElementListesi); // [3, 5, 6, 7, 2, 8, 1, 4]//
                                                    //benzersizElementListesi şu anda bir List
        arr = new int[benzersizElementListesi.size()];//benzersizElementListesi adında arrays oluşturduk

        System.out.println(Arrays.toString(arr)); // [0, 0, 0, 0, 0, 0, 0, 0]


        for (int i = 0; i < arr.length ; i++) {//index olmadan List'ten arrays e atama yapamayız, for kullanıyoruz
