...
public class C02_Mutable_ImmutableClasses {
    ...
    public static void main(String[] args) {
       ...
       String str= "Java gun gectikce daha da keyifli oluyor";
        ...
        str.substring(5);//her bir işlemden sonra atama yapar yazdırırsak veya yazdırmada bu işlemleri
        str.substring(3,15);      //yaparsak değişiklik kalıcı olur
        str.startsWith("Java");
        str.toLowerCase();

        System.out.println(str); // Java gun gectikce daha da keyifli oluyor
                                //birçok işlem yaptığımız halde değişmedi
