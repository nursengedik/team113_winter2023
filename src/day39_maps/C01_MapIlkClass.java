...
public class C01_MapIlkClass {
    ...
    public static void main(String[] args) {
        ...
        okulMap.put(101, "Ali, Cem, 10, H, MF");//okulMap ine element eklemek için put kullanılır
        okulMap.put(102, "Veli, Can, 10, M, TM");//bir key ve bir value içerir
        ...
        System.out.println(okulMap);//okulMap i yazdırır

        //{101=Ali, Cem, 10, H, MF, 102=Veli, Can, 10, M, TM, 103=Ali, Can, 11, M, Soz, 104=Ayse, Cem, 11, H, TM,
        // 105=Ayse, Han, 10, H, MF, 106=Veli, Han, 10, H, MF}
