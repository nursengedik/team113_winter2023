...
public class C04_Child extends C03_ParentClass  {
    ...
    public static void main(String[] args) {
        ...
        C03_ParentClass objC03 = new C03_ParentClass();//C03 class ından obje oluşturduk
        objC03.a=20;
        objC03.b=22;
        objC03.s="p";
        objC03.t="k";
        ...
        C04_Child objC04 = new C04_Child();//bulunduğumuz class tan obje oluşturduk ve o classtaki datalara ulaştık
        objC04.a=50;
        objC04.c=20;
        objC04.s="u";
        objC04.m="l";
