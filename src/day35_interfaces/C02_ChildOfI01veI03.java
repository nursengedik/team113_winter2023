...
public class C02_ChildOfI01veI03 implements I01_Interface,I03_Interface{
    ...
    /*
        ...
        ayni isimde fakat farkli return type'i olan method'lar varsa (String ekleme();  ve int ekelem(); gibi)
    ...
    public static void main(String[] args) {
        C02_ChildOfI01veI03 obj = new C02_ChildOfI01veI03();
         ...
         //obj. yazdığımızda C02_ChildOfI01veI03 classtaki methodlar hazır olarak gelir ama variableler hazır olarak
        //gelmez, interfaces adını kullanarak çağırırız

        System.out.println(I01_Interface.str);//variablelere statik olarak böyle ulaşılır
